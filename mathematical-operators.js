...
const tastes = 'zoet';
const tastes2 = 'sappig';
const outcome = tastes + tastes2;
console.log(outcome);
...
const preName = 'Jasper';
const lastName = 'Hendrikx';
const outcome2 = preName + ' ' + lastName;
...
const placeWereIlive = city + ', ' + province
console.log(placeWereIlive)